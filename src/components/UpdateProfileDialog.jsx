                ...
                <DialogContent className="sm:max-w-[425px]" onInteractOutside={() => setOpen(false)}>
                    ...
                    <form onSubmit={submitHandler}>
                        <div className='grid gap-4 py-4'>
                            ...
                            <div className='grid grid-cols-4 items-center gap-4'>
                                <Label htmlFor="bio" className="text-right">Biographie</Label>
                                <Input
                                    id="bio"
                                    name="bio"
                                    value={input.bio}
                        ...
                        <DialogFooter>
                            {
                                loading ? <Button className="w-full my-4"> <Loader2 className='mr-2 h-4 w-4 animate-spin' /> Veuillez patienter </Button> : <Button type="submit" className="w-full my-4">Mettre à jour</Button>
                            }
                        </DialogFooter>
                    </form>
                </DialogContent>
